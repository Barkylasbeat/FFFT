...
HD_PWD='C:/Github/FFFT/FFT_Xilinx/FFT_Xilinx.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Test_Xilinx_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Test_Xilinx_wrapper.tcl -notrace
