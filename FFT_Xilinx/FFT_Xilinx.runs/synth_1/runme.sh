...
HD_PWD='C:/Users/donat/Desktop/NL2_FFT/Git_FFFT/FFFT/FFT_Xilinx/FFT_Xilinx.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Test_Xilinx_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Test_Xilinx_wrapper.tcl
