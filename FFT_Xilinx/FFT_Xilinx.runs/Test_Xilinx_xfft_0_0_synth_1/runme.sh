...
HD_PWD='C:/Github/FFFT/FFT_Xilinx/FFT_Xilinx.runs/Test_Xilinx_xfft_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Test_Xilinx_xfft_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Test_Xilinx_xfft_0_0.tcl
