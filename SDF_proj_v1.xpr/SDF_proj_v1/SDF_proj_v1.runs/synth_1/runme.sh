...
HD_PWD='/home/fralenzi/SDF_proj_v1/SDF_proj_v1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SDF_Stage.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SDF_Stage.tcl
