...
namespace eval ::optrace {
  variable script "C:/Github/FFFT/SDF_proj_v2.xpr/SDF_proj_v2/SDF_proj_v2.runs/synth_1/SDF_Top.tcl"
...
synth_design -top SDF_Top -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef SDF_Top.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file SDF_Top_utilization_synth.rpt -pb SDF_Top_utilization_synth.pb"
